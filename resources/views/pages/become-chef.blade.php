...
@section('content')
    ...
    <div class="container margin_60">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="box_home" id="one">
                    <span>1</span>
                    <h3>Enroll your kitchen</h3>
                    <p>
                        Upload details and images of your kitchen
                    </p>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div id="delivery_time" class="hidden-xs">
            ...
            <h4>The minutes that usually takes to start your own business!</h4>
        </div>
