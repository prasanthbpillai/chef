        ...
        <div id="sub_content">
            ...
            <div class="bs-wizard">
                ...
                <div class="col-xs-4 bs-wizard-step disabled">
                    <div class="text-center bs-wizard-stepnum"><strong>2.</strong> Kitchen Details</div>
                    <div class="progress"><div class="progress-bar"></div></div>
                    <a href="cart_2.html" class="bs-wizard-dot"></a>
                </div>

                <div class="col-xs-4 bs-wizard-step disabled">
                    <div class="text-center bs-wizard-stepnum"><strong>3.</strong> Upload Pictures!</div>
                    <div class="progress"><div class="progress-bar"></div></div>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="box_style_2 hidden-xs info">
                <h4 class="nomargin_top">Tips <i class="icon_clock_alt pull-right"></i></h4>
                <p>
                    Lorem ipsum dolor sit amet, in pri partem essent. Qui debitis meliore ex, tollit debitis conclusionemque te eos.
                </p>
                <hr>
                <h4>Bookings <i class="icon_creditcard pull-right"></i></h4>
                <p>
                    Lorem ipsum dolor sit amet, in pri partem essent. Qui debitis meliore ex, tollit debitis conclusionemque te eos.
                </p>
            </div><!-- End box_style_1 -->
